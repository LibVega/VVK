...
{
	/// <summary>
	/// Represents a fixed string buffer of size <see cref="VkConstants.MAX_DRIVER_NAME_SIZE"/>.
	/// </summary>
	[StructLayout(LayoutKind.Explicit, Size = (int)VkConstants.MAX_DRIVER_NAME_SIZE)]
	public unsafe struct DriverName : IFixedString
	{
		/// <summary>
		/// The size of the fixed string buffer in this type.
		/// </summary>
		public const int SIZE = (int)VkConstants.MAX_DRIVER_NAME_SIZE;
		...
		public DriverName(byte* str, int length)
		{
		...
		#region Operators
		public static bool operator == (in DriverName str1, in DriverName str2)
		{
		...
		public static bool operator == (in DriverName str1, string? str2)
		{
		...
		public static bool operator == (string? str1, in DriverName str2)
		{
		...
		#region Casting
		public static implicit operator DriverName (string str) => new DriverName(str);

		public static implicit operator string (in DriverName fs) => fs.ToString() ?? String.Empty;
		#endregion // Casting
	}
}
