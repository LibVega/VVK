...
{
	/// <summary>
	/// Represents a fixed string buffer of size <see cref="VkConstants.MAX_EXTENSION_NAME_SIZE"/>.
	/// </summary>
	[StructLayout(LayoutKind.Explicit, Size = (int)VkConstants.MAX_EXTENSION_NAME_SIZE)]
	public unsafe struct ExtensionName : IFixedString
	{
		/// <summary>
		/// The size of the fixed string buffer in this type.
		/// </summary>
		public const int SIZE = (int)VkConstants.MAX_EXTENSION_NAME_SIZE;
		...
		public ExtensionName(string str)
		{
		...
		public ExtensionName(byte* str, int length)
		{
		...
		#region Operators
		public static bool operator == (in ExtensionName str1, in ExtensionName str2)
		{
		...
		public static bool operator == (in ExtensionName str1, string? str2)
		{
		...
		public static bool operator == (string? str1, in ExtensionName str2)
		{
		...
		#region Casting
		public static implicit operator ExtensionName (string str) => new ExtensionName(str);

		public static implicit operator string (in ExtensionName fs) => fs.ToString() ?? String.Empty;
		#endregion // Casting
	}
}
