...
{
	/// <summary>
	/// Represents a fixed string buffer of size <see cref="VkConstants.MAX_PHYSICAL_DEVICE_NAME_SIZE"/>.
	/// </summary>
	[StructLayout(LayoutKind.Explicit, Size = (int)VkConstants.MAX_PHYSICAL_DEVICE_NAME_SIZE)]
	public unsafe struct PhysicalDeviceName : IFixedString
	{
		/// <summary>
		/// The size of the fixed string buffer in this type.
		/// </summary>
		public const int SIZE = (int)VkConstants.MAX_PHYSICAL_DEVICE_NAME_SIZE;
		...
		public PhysicalDeviceName(string str)
		{
		...
		public PhysicalDeviceName(byte* str, int length)
		{
		...
		#region Operators
		public static bool operator == (in PhysicalDeviceName str1, in PhysicalDeviceName str2)
		{
		...
		public static bool operator == (in PhysicalDeviceName str1, string? str2)
		{
		...
		public static bool operator == (string? str1, in PhysicalDeviceName str2)
		{
		...
		#region Casting
		public static implicit operator PhysicalDeviceName (string str) => new PhysicalDeviceName(str);

		public static implicit operator string (in PhysicalDeviceName fs) => fs.ToString() ?? String.Empty;
		#endregion // Casting
	}
}
