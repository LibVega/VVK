...
public unsafe static partial class StaticFunctionTable
{
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VulkanHandle<VkAccelerationStructureKHR>, VkAllocationCallbacks*, void> _vkDestroyAccelerationStructureNV = null;
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VkAccelerationStructureMemoryRequirementsInfoKHR*, VkMemoryRequirements2*, void> _vkGetAccelerationStructureMemoryRequirementsKHR = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, uint, VkBindAccelerationStructureMemoryInfoKHR*, VkResult> _vkBindAccelerationStructureMemoryKHR = null;
	private static delegate* unmanaged<VulkanHandle<VkDevice>, uint, VkBindAccelerationStructureMemoryInfoKHR*, VkResult> _vkBindAccelerationStructureMemoryNV = null;
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, VulkanHandle<VkAccelerationStructureKHR>, VulkanHandle<VkAccelerationStructureKHR>, VkCopyAccelerationStructureModeKHR, void> _vkCmdCopyAccelerationStructureNV = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VkCopyAccelerationStructureInfoKHR*, VkResult> _vkCopyAccelerationStructureKHR = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VkCopyAccelerationStructureToMemoryInfoKHR*, VkResult> _vkCopyAccelerationStructureToMemoryKHR = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VkCopyMemoryToAccelerationStructureInfoKHR*, VkResult> _vkCopyMemoryToAccelerationStructureKHR = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, uint, VulkanHandle<VkAccelerationStructureKHR>*, VkQueryType, VulkanHandle<VkQueryPool>, uint, void> _vkCmdWriteAccelerationStructuresPropertiesNV = null;
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, VkAccelerationStructureInfoNV*, VulkanHandle<VkBuffer>, ulong, VkBool32, VulkanHandle<VkAccelerationStructureKHR>, VulkanHandle<VkAccelerationStructureKHR>, VulkanHandle<VkBuffer>, ulong, void> _vkCmdBuildAccelerationStructureNV = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, VkStridedBufferRegionKHR*, VkStridedBufferRegionKHR*, VkStridedBufferRegionKHR*, VkStridedBufferRegionKHR*, uint, uint, uint, void> _vkCmdTraceRaysKHR = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VulkanHandle<VkAccelerationStructureKHR>, ulong, void*, VkResult> _vkGetAccelerationStructureHandleNV = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VulkanHandle<VkPipelineCache>, uint, VkRayTracingPipelineCreateInfoKHR*, VkAllocationCallbacks*, VulkanHandle<VkPipeline>*, VkResult> _vkCreateRayTracingPipelinesKHR = null;
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, VkStridedBufferRegionKHR*, VkStridedBufferRegionKHR*, VkStridedBufferRegionKHR*, VkStridedBufferRegionKHR*, VulkanHandle<VkBuffer>, ulong, void> _vkCmdTraceRaysIndirectKHR = null;
	private static delegate* unmanaged<VulkanHandle<VkDevice>, VkAccelerationStructureVersionKHR*, VkResult> _vkGetDeviceAccelerationStructureCompatibilityKHR = null;
	...
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, uint, VkAccelerationStructureBuildGeometryInfoKHR*, VkAccelerationStructureBuildOffsetInfoKHR**, void> _vkCmdBuildAccelerationStructureKHR = null;
	private static delegate* unmanaged<VulkanHandle<VkCommandBuffer>, VkAccelerationStructureBuildGeometryInfoKHR*, VulkanHandle<VkBuffer>, ulong, uint, void> _vkCmdBuildAccelerationStructureIndirectKHR = null;
	private static delegate* unmanaged<VulkanHandle<VkDevice>, uint, VkAccelerationStructureBuildGeometryInfoKHR*, VkAccelerationStructureBuildOffsetInfoKHR**, VkResult> _vkBuildAccelerationStructureKHR = null;
